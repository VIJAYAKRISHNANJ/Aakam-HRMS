...
function Exits() {
  ...
  /*
   * HR Administrator uses the canonical offboarding
   * permission namespace.
   */
  const canViewExits =
    hasPermission("offboarding.view");

  const canViewOwnExits =
    hasPermission("offboarding.view.own");

  const canCreateExit =
    hasPermission("offboarding.create");

  const canUpdateExit =
    hasPermission("offboarding.update");
        ...
        <div className="flex min-h-[520px] items-center justify-center px-6">
          <div className="max-w-md text-center">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              You do not have permission to view exit records.
            </p>
          ...
          <div className="grid gap-3 md:grid-cols-3 lg:grid-cols-6">
            <div className="relative">
              ...
              <input
                ...
                className="h-10 w-full rounded-lg border border-slate-300 pl-9 pr-3 text-sm outline-none focus:border-teal-600"
              />
            </div>
                    ...
                    (record) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-4">
                          <span
                            className={`rounded-full px-2.5 py-1 text-xs font-semibold ${statusClass(record.approvalStatus)}`}
                          >
                            {
                              approvalLabels[
